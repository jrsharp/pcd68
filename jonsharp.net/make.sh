...
m68k-unknown-elf-g++ -O0 -s -g -o pcd68home pcd68home.S content_single.S utility_functions.S picture_data.S picture_data2.S $MENU_DEFINE -nostdlib -fomit-frame-pointer -mno-rtd -m68000 -msoft-float -T pcd68.lds
